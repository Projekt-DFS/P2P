...
public class Peer {
	...
	//Variablen
		...
		protected static InetAddress inet;
		
		//private  HashMap neighbours = new HashMap();
		private  HashMap<Integer, Peer> neighbours = new HashMap<>();
	...
	/*
		...
		*/	
		...
		public void setNeighbours(HashMap neighbours) {
			this.neighbours = neighbours;
		}
		public static HashMap<Long, Zone> getCoordinates() {
			return coordinates;
		}
		public static void setCoordinates(HashMap<Long, Zone> coordinates) {
